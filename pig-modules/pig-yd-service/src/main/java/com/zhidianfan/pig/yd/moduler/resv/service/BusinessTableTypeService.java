...
public class BusinessTableTypeService {
    ...
    public boolean typeAdd(BusinessTableTypeDTO businessTableTypeDTO) {
        ...
        businessTableType.setBusinessId(businessTableTypeDTO.getBusinessId());
    ...
    public boolean typeEdit(BusinessTableTypeDTO businessTableTypeDTO) {
        ...
        TableType tableType = iTableTypeService.selectById(id);
        if(tableType==null){
        ...
        condition.setTableTypeId(id);
        condition.setBusinessId(businessTableTypeDTO.getBusinessId());

        Table table = new Table();
        Integer maxPeopleNum = businessTableTypeDTO.getMaxPeopleNum();
        if(maxPeopleNum!=null)
            table.setMaxPeopleNum(maxPeopleNum+"");
        Integer minPeopleNum = businessTableTypeDTO.getMinPeopleNum();
        if(minPeopleNum!=null)
            table.setMinPeopleNum(minPeopleNum+"");
