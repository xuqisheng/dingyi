 ...
 * @since 2018-09-03
 */
@TableName("resv_order_his")
public class ResvOrderHis extends Model<ResvOrderHis> {
    ...
    public String toString() {
        ...
        ", payType=" + payType +
        ", resvOrderType=" + resvOrderType +
        ", lockedType=" + lockedType +
        ", resvMeetingOrderNo=" + resvMeetingOrderNo +
        ", externalSourceName=" + externalSourceName +
        ", externalSourceId=" + externalSourceId +
        ", isTirdparty=" + isTirdparty +
        ", isChangeTable=" + isChangeTable +
        ", isKbc=" + isKbc +
        ", tag=" + tag +
        ", peicaiAmt=" + peicaiAmt +
        ", peicaiType=" + peicaiType +
        ", destTime=" + destTime +
        ", propertyId=" + propertyId +
        ", propertyName=" + propertyName +
        ", isRank=" + isRank +
        ", isSendMsg=" + isSendMsg +
        ", reVipPhone=" + reVipPhone +
        ", reVipName=" + reVipName +
        ", reVipSex=" + reVipSex +
        ", openIsSync=" + openIsSync +
