...
public class PushTagListener {
    ...
    public void onMessage(Message message, Channel channel) {
        ...
        try {
            ...
            Set<String> tags = JsonUtils.jsonStr2Obj(pushMessage.getClient(),Set.class);
            pushService.pushToTag(tags, pushMessage.getMessage(),pushMessage);
        } catch (Exception e) {
            log.info("日志入库失败：\n{}", e.getMessage());
        }
